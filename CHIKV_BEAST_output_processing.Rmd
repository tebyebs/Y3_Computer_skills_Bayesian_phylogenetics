...
```{r}
# Load the MCC tree
beast_file <- ("/Users/rhysinward/Downloads/MCC_CHIKV_IndianOcean.tree")
...
```{r}
beast_log <- read.csv("/Users/rhysinward/Downloads/CHIKV_IndianOcean_BEAST_output_log.csv")
head(beast_log)
```
