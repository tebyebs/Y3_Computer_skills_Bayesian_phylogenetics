...
Imagine a fictitious scenario where, following the 2018 outbreak, CHIKV infections
continued to be reported in Kassala throughout 2019. We have expanded the original
data set to include 7 new CHIKV genome sequences (please note that, since this
scenario is fictitious, the 2019 Kassala sequences are synthetic and created for the
purpose of this exercise). A similar analysis to the 2018 outbreak was performed, the
resulting tree can be found in the MCC_CHIKV_IndianOcean_updated.tree file and
the log file can be found as CHIKV_IndianOcean_updated_BEAST_output_log.csv.
Are the 2019 cases a continuation of the 2018 epidemic or a different outbreak?
Justify your answer with a visualisation of the tree and its interpretation.
