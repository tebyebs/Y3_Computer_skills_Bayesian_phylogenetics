...
The updated log file contains parameter estimates for the MRCAs for the 2018
(age(Kassala_2018)) and 2019 (age(Kassala_2019)) sequences. From a comparison
of these dates and the specific times when cases started to increase for each season
(July in 2018 and April in 2019), is there evidence for new CHIKV importations
happening during the same time every year? Why? Are importation times related to
the timing when epidemics start to take off?
...
updated_beast_log_burnin |>
  ...
  theme_classic()
```
From the above graph, we can see that the MRCA for the 2019 outbreak is estimated to be between mid to late 2018, while the 2018 outbreak's MRCA is around early to mid 2017. It is interesting to note that the additional 2019 samples have changed the 2018 outbreak MRCA, presumably shifting this date forward in response to the later sample that branched out of the 2018 cases. This indicates THEY DO NOT START AT TEH SAME TIME ACH YEAR

Comparing the estimated MRCAs of the two outbreaks with the point at which 
see that there is a difference - one is faster
importation times are linked - getting importation in winter/rainy season - more mosquitos - more spread
getting in summer/dry season - less mosquitos - less spread - longer delay 
